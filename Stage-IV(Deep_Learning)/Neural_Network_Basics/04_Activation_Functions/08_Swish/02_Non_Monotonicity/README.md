...
**Context:** Activation Functions > Swish > Non_Monotonicity
...
Teach me "Non Monotonicity" as part of the topic "Swish" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Non Monotonicity in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Non Monotonicity from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Non Monotonicity?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Non Monotonicity connect to the broader context of "Swish"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Non Monotonicity correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Non Monotonicity |
| **Parent Section** | Swish |
| **Full Path** | `Activation Functions > Swish > Non_Monotonicity` |
