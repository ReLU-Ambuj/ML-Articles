...
**Context:** Activation Functions > ReLU > Piecewise_Linear_Form
...
Teach me "Piecewise Linear Form" as part of the topic "ReLU" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Piecewise Linear Form in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Piecewise Linear Form from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Piecewise Linear Form?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Piecewise Linear Form connect to the broader context of "ReLU"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Piecewise Linear Form correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Piecewise Linear Form |
| **Parent Section** | ReLU |
| **Full Path** | `Activation Functions > ReLU > Piecewise_Linear_Form` |
