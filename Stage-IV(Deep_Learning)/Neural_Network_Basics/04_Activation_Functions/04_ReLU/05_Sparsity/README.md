...
**Context:** Activation Functions > ReLU > Sparsity
...
Teach me "Sparsity" as part of the topic "ReLU" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Sparsity in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Sparsity from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Sparsity?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Sparsity connect to the broader context of "ReLU"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Sparsity correctly, using a real or toy dataset.
...
| **Topic** | Sparsity |
| **Parent Section** | ReLU |
| **Full Path** | `Activation Functions > ReLU > Sparsity` |
