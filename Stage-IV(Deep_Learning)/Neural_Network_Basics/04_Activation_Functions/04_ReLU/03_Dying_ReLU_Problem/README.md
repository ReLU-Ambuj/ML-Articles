...
**Context:** Activation Functions > ReLU > Dying_ReLU_Problem
...
Teach me "Dying ReLU Problem" as part of the topic "ReLU" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Dying ReLU Problem in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Dying ReLU Problem from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Dying ReLU Problem?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Dying ReLU Problem connect to the broader context of "ReLU"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Dying ReLU Problem correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Dying ReLU Problem |
| **Parent Section** | ReLU |
| **Full Path** | `Activation Functions > ReLU > Dying_ReLU_Problem` |
