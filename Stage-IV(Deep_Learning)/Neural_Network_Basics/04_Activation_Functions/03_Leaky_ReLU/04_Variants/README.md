...
**Context:** Activation Functions > Leaky ReLU > Variants
...
Teach me "Variants" as part of the topic "Leaky ReLU" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Variants in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Variants from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Variants?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Variants connect to the broader context of "Leaky ReLU"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Variants correctly, using a real or toy dataset.
...
| **Full Path** | `Activation Functions > Leaky ReLU > Variants` |
