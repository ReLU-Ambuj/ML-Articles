...
**Context:** Activation Functions > Leaky ReLU > Negative_Slope
...
Teach me "Negative Slope" as part of the topic "Leaky ReLU" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Negative Slope in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Negative Slope from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Negative Slope?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Negative Slope connect to the broader context of "Leaky ReLU"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Negative Slope correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Negative Slope |
| **Parent Section** | Leaky ReLU |
| **Full Path** | `Activation Functions > Leaky ReLU > Negative_Slope` |
