...
**Context:** Activation Functions > Softmax > Multi_Class_Outputs
...
Teach me "Multi Class Outputs" as part of the topic "Softmax" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Multi Class Outputs in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Multi Class Outputs from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Multi Class Outputs?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Multi Class Outputs connect to the broader context of "Softmax"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Multi Class Outputs correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Multi Class Outputs |
| **Parent Section** | Softmax |
| **Full Path** | `Activation Functions > Softmax > Multi_Class_Outputs` |
