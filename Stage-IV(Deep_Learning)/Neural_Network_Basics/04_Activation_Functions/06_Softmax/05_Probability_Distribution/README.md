...
**Context:** Activation Functions > Softmax > Probability_Distribution
...
Teach me "Probability Distribution" as part of the topic "Softmax" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Probability Distribution in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Probability Distribution from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Probability Distribution?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Probability Distribution connect to the broader context of "Softmax"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Probability Distribution correctly, using a real or toy dataset.
...
| **Full Path** | `Activation Functions > Softmax > Probability_Distribution` |
