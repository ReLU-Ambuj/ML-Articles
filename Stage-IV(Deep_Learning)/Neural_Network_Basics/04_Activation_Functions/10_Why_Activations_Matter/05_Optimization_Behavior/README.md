...
**Context:** Activation Functions > Why Activations Matter > Optimization_Behavior
...
Teach me "Optimization Behavior" as part of the topic "Why Activations Matter" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Optimization Behavior in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Optimization Behavior from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Optimization Behavior?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Optimization Behavior connect to the broader context of "Why Activations Matter"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Optimization Behavior correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Optimization Behavior |
| **Parent Section** | Why Activations Matter |
| **Full Path** | `Activation Functions > Why Activations Matter > Optimization_Behavior` |
