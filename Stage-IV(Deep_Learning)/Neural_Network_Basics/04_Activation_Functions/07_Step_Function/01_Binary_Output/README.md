...
**Context:** Activation Functions > Step Function > Binary_Output
...
Teach me "Binary Output" as part of the topic "Step Function" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Binary Output in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Binary Output from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Binary Output?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Binary Output connect to the broader context of "Step Function"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Binary Output correctly, using a real or toy dataset.
...
| **Full Path** | `Activation Functions > Step Function > Binary_Output` |
