...
**Context:** Activation Functions > Sigmoid > Logistic_Function
...
Teach me "Logistic Function" as part of the topic "Sigmoid" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Logistic Function in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Logistic Function from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Logistic Function?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Logistic Function connect to the broader context of "Sigmoid"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Logistic Function correctly, using a real or toy dataset.
...
| **Full Path** | `Activation Functions > Sigmoid > Logistic_Function` |
