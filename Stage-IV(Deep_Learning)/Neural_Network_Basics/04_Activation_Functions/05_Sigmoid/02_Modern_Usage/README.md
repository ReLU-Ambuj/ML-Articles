...
**Context:** Activation Functions > Sigmoid > Modern_Usage
...
Teach me "Modern Usage" as part of the topic "Sigmoid" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Modern Usage in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Modern Usage from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Modern Usage?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Modern Usage connect to the broader context of "Sigmoid"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Modern Usage correctly, using a real or toy dataset.
...
| **Full Path** | `Activation Functions > Sigmoid > Modern_Usage` |
