...
**Context:** Activation Functions > Tanh > Zero_Centered_Outputs
...
Teach me "Zero Centered Outputs" as part of the topic "Tanh" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Zero Centered Outputs in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Zero Centered Outputs from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Zero Centered Outputs?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Zero Centered Outputs connect to the broader context of "Tanh"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Zero Centered Outputs correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Zero Centered Outputs |
| **Parent Section** | Tanh |
| **Full Path** | `Activation Functions > Tanh > Zero_Centered_Outputs` |
