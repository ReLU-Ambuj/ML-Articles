...
**Context:** Activation Functions > Tanh > Gradient_Properties
...
Teach me "Gradient Properties" as part of the topic "Tanh" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Gradient Properties in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Gradient Properties from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Gradient Properties?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Gradient Properties connect to the broader context of "Tanh"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Gradient Properties correctly, using a real or toy dataset.
...
| **Parent Section** | Tanh |
| **Full Path** | `Activation Functions > Tanh > Gradient_Properties` |
