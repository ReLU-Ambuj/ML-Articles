...
**Context:** Perceptrons > Linear Decision Boundaries > Half_Spaces
...
Teach me "Half Spaces" as part of the topic "Linear Decision Boundaries" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Half Spaces in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Half Spaces from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Half Spaces?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Half Spaces connect to the broader context of "Linear Decision Boundaries"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Half Spaces correctly, using a real or toy dataset.
...
| **Full Path** | `Perceptrons > Linear Decision Boundaries > Half_Spaces` |
