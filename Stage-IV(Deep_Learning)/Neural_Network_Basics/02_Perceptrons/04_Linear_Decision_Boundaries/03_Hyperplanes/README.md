...
**Context:** Perceptrons > Linear Decision Boundaries > Hyperplanes
...
Teach me "Hyperplanes" as part of the topic "Linear Decision Boundaries" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Hyperplanes in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Hyperplanes from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Hyperplanes?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Hyperplanes connect to the broader context of "Linear Decision Boundaries"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Hyperplanes correctly, using a real or toy dataset.
...
| **Full Path** | `Perceptrons > Linear Decision Boundaries > Hyperplanes` |
