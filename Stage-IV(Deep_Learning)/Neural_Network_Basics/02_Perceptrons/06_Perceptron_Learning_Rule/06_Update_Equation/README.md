...
**Context:** Perceptrons > Perceptron Learning Rule > Update_Equation
...
Teach me "Update Equation" as part of the topic "Perceptron Learning Rule" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Update Equation in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Update Equation from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Update Equation?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Update Equation connect to the broader context of "Perceptron Learning Rule"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Update Equation correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Update Equation |
| **Parent Section** | Perceptron Learning Rule |
| **Full Path** | `Perceptrons > Perceptron Learning Rule > Update_Equation` |
