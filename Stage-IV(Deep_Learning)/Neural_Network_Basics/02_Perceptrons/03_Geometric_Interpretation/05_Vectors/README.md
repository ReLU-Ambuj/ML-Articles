...
**Context:** Perceptrons > Geometric Interpretation > Vectors
...
Teach me "Vectors" as part of the topic "Geometric Interpretation" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Vectors in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Vectors from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Vectors?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Vectors connect to the broader context of "Geometric Interpretation"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Vectors correctly, using a real or toy dataset.
...
| **Full Path** | `Perceptrons > Geometric Interpretation > Vectors` |
