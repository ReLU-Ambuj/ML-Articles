...
**Context:** Perceptrons > XOR Failure > Geometric_Proof
...
Teach me "Geometric Proof" as part of the topic "XOR Failure" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Geometric Proof in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Geometric Proof from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Geometric Proof?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Geometric Proof connect to the broader context of "XOR Failure"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Geometric Proof correctly, using a real or toy dataset.
...
| **Full Path** | `Perceptrons > XOR Failure > Geometric_Proof` |
