...
**Context:** Perceptrons > Bias Term > Learnable_Parameter
...
Teach me "Learnable Parameter" as part of the topic "Bias Term" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Learnable Parameter in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Learnable Parameter from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Learnable Parameter?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Learnable Parameter connect to the broader context of "Bias Term"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Learnable Parameter correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Learnable Parameter |
| **Parent Section** | Bias Term |
| **Full Path** | `Perceptrons > Bias Term > Learnable_Parameter` |
