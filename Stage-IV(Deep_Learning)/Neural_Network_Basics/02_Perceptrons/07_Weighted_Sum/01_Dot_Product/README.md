...
**Context:** Perceptrons > Weighted Sum > Dot_Product
...
Teach me "Dot Product" as part of the topic "Weighted Sum" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Dot Product in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Dot Product from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Dot Product?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Dot Product connect to the broader context of "Weighted Sum"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Dot Product correctly, using a real or toy dataset.
...
| **Full Path** | `Perceptrons > Weighted Sum > Dot_Product` |
