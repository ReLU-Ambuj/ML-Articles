...
**Context:** Perceptrons > Weighted Sum > Negative_Weights
...
Teach me "Negative Weights" as part of the topic "Weighted Sum" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Negative Weights in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Negative Weights from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Negative Weights?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Negative Weights connect to the broader context of "Weighted Sum"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Negative Weights correctly, using a real or toy dataset.
...
| **Full Path** | `Perceptrons > Weighted Sum > Negative_Weights` |
