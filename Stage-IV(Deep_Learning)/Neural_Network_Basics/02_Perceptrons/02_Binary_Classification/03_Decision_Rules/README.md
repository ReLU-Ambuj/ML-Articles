...
**Context:** Perceptrons > Binary Classification > Decision_Rules
...
Teach me "Decision Rules" as part of the topic "Binary Classification" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Decision Rules in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Decision Rules from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Decision Rules?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Decision Rules connect to the broader context of "Binary Classification"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Decision Rules correctly, using a real or toy dataset.
...
| **Full Path** | `Perceptrons > Binary Classification > Decision_Rules` |
