...
**Context:** Perceptrons > Mathematical Model > Input_Vector_x
...
Teach me "Input Vector x" as part of the topic "Mathematical Model" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Input Vector x in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Input Vector x from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Input Vector x?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Input Vector x connect to the broader context of "Mathematical Model"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Input Vector x correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Input Vector x |
| **Parent Section** | Mathematical Model |
| **Full Path** | `Perceptrons > Mathematical Model > Input_Vector_x` |
