...
**Context:** History and Motivation > Biological Inspiration > Synapses
...
Teach me "Synapses" as part of the topic "Biological Inspiration" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Synapses in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Synapses from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Synapses?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Synapses connect to the broader context of "Biological Inspiration"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Synapses correctly, using a real or toy dataset.
...
| **Full Path** | `History and Motivation > Biological Inspiration > Synapses` |
