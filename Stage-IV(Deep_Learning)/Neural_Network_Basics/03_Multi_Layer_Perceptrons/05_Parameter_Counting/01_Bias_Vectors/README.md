...
**Context:** Multi Layer Perceptrons > Parameter Counting > Bias_Vectors
...
Teach me "Bias Vectors" as part of the topic "Parameter Counting" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Bias Vectors in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Bias Vectors from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Bias Vectors?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Bias Vectors connect to the broader context of "Parameter Counting"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Bias Vectors correctly, using a real or toy dataset.
...
| **Full Path** | `Multi Layer Perceptrons > Parameter Counting > Bias_Vectors` |
