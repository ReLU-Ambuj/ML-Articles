...
**Context:** Multi Layer Perceptrons > Parameter Counting > Memory_Requirements
...
Teach me "Memory Requirements" as part of the topic "Parameter Counting" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Memory Requirements in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Memory Requirements from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Memory Requirements?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Memory Requirements connect to the broader context of "Parameter Counting"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Memory Requirements correctly, using a real or toy dataset.
...
| **Parent Section** | Parameter Counting |
| **Full Path** | `Multi Layer Perceptrons > Parameter Counting > Memory_Requirements` |
