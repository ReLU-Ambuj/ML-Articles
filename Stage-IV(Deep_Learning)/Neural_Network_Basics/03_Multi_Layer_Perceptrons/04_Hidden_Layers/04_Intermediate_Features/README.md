...
**Context:** Multi Layer Perceptrons > Hidden Layers > Intermediate_Features
...
Teach me "Intermediate Features" as part of the topic "Hidden Layers" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Intermediate Features in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Intermediate Features from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Intermediate Features?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Intermediate Features connect to the broader context of "Hidden Layers"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Intermediate Features correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Intermediate Features |
| **Parent Section** | Hidden Layers |
| **Full Path** | `Multi Layer Perceptrons > Hidden Layers > Intermediate_Features` |
