...
**Context:** Multi Layer Perceptrons > Expressive Power > Hierarchical_Features
...
Teach me "Hierarchical Features" as part of the topic "Expressive Power" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Hierarchical Features in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Hierarchical Features from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Hierarchical Features?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Hierarchical Features connect to the broader context of "Expressive Power"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Hierarchical Features correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Hierarchical Features |
| **Parent Section** | Expressive Power |
| **Full Path** | `Multi Layer Perceptrons > Expressive Power > Hierarchical_Features` |
