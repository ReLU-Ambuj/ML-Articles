...
**Context:** Multi Layer Perceptrons > Expressive Power > Piecewise_Linear_Functions
...
Teach me "Piecewise Linear Functions" as part of the topic "Expressive Power" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Piecewise Linear Functions in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Piecewise Linear Functions from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Piecewise Linear Functions?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Piecewise Linear Functions connect to the broader context of "Expressive Power"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Piecewise Linear Functions correctly, using a real or toy dataset.
...
| **Full Path** | `Multi Layer Perceptrons > Expressive Power > Piecewise_Linear_Functions` |
