...
**Context:** Multi Layer Perceptrons > Expressive Power > Function_Composition
...
Teach me "Function Composition" as part of the topic "Expressive Power" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Function Composition in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Function Composition from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Function Composition?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Function Composition connect to the broader context of "Expressive Power"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Function Composition correctly, using a real or toy dataset.
...
| **Full Path** | `Multi Layer Perceptrons > Expressive Power > Function_Composition` |
