...
**Context:** Backpropagation > Forward_Mode_AD
...
Teach me "Forward Mode AD" as part of the topic "Backpropagation" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Forward Mode AD in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Forward Mode AD from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Forward Mode AD?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Forward Mode AD connect to the broader context of "Backpropagation"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Forward Mode AD correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Forward Mode AD |
| **Parent Section** | Backpropagation |
| **Full Path** | `Backpropagation > Forward_Mode_AD` |
