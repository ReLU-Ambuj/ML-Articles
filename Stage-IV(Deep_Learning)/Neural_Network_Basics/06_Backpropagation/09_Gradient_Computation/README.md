...
**Context:** Backpropagation > Gradient_Computation
...
Teach me "Gradient Computation" as part of the topic "Backpropagation" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Gradient Computation in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Gradient Computation from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Gradient Computation?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Gradient Computation connect to the broader context of "Backpropagation"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Gradient Computation correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Gradient Computation |
| **Parent Section** | Backpropagation |
| **Full Path** | `Backpropagation > Gradient_Computation` |
