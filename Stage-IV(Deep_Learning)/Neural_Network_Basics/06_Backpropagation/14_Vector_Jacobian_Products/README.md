...
**Context:** Backpropagation > Vector_Jacobian_Products
...
Teach me "Vector Jacobian Products" as part of the topic "Backpropagation" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Vector Jacobian Products in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Vector Jacobian Products from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Vector Jacobian Products?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Vector Jacobian Products connect to the broader context of "Backpropagation"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Vector Jacobian Products correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Vector Jacobian Products |
| **Parent Section** | Backpropagation |
| **Full Path** | `Backpropagation > Vector_Jacobian_Products` |
