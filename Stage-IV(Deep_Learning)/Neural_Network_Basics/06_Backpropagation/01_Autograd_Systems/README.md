...
**Context:** Backpropagation > Autograd_Systems
...
Teach me "Autograd Systems" as part of the topic "Backpropagation" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Autograd Systems in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Autograd Systems from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Autograd Systems?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Autograd Systems connect to the broader context of "Backpropagation"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Autograd Systems correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Autograd Systems |
| **Parent Section** | Backpropagation |
| **Full Path** | `Backpropagation > Autograd_Systems` |
