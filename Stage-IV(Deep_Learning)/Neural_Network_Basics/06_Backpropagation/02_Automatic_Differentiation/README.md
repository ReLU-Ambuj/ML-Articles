...
**Context:** Backpropagation > Automatic_Differentiation
...
Teach me "Automatic Differentiation" as part of the topic "Backpropagation" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Automatic Differentiation in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Automatic Differentiation from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Automatic Differentiation?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Automatic Differentiation connect to the broader context of "Backpropagation"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Automatic Differentiation correctly, using a real or toy dataset.
...
| **Full Path** | `Backpropagation > Automatic_Differentiation` |
