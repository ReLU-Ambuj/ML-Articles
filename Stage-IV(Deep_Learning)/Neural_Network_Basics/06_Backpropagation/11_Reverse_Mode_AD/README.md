...
**Context:** Backpropagation > Reverse_Mode_AD
...
Teach me "Reverse Mode AD" as part of the topic "Backpropagation" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Reverse Mode AD in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Reverse Mode AD from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Reverse Mode AD?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Reverse Mode AD connect to the broader context of "Backpropagation"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Reverse Mode AD correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Reverse Mode AD |
| **Parent Section** | Backpropagation |
| **Full Path** | `Backpropagation > Reverse_Mode_AD` |
