...
**Context:** Optimization Algorithms > Adaptive Methods > AdaGrad
...
Teach me "AdaGrad" as part of the topic "Adaptive Methods" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is AdaGrad in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement AdaGrad from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about AdaGrad?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does AdaGrad connect to the broader context of "Adaptive Methods"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood AdaGrad correctly, using a real or toy dataset.
...
| **Full Path** | `Optimization Algorithms > Adaptive Methods > AdaGrad` |
