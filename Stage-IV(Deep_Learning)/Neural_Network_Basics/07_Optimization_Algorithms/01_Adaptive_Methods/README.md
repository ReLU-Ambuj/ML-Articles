...
**Section:** Optimization Algorithms > Adaptive Methods

---

## Section Overview Prompt

Use this prompt to get an overview of the entire **Adaptive Methods** section before diving into subtopics:

```
You are an expert deep learning educator.

Give me a complete structured overview of "Adaptive Methods" as it appears in deep learning,
...
5. Common misconceptions beginners have about Adaptive Methods.
...
- [AdaGrad](./02_AdaGrad/README.md)
- [RMSProp](./06_RMSProp/README.md)
- [Adam](./03_Adam/README.md)
- [AdamW](./04_AdamW/README.md)
- [AdaFactor](./01_AdaFactor/README.md)
- [LAMB](./05_LAMB/README.md)
