...
**Context:** Optimization Algorithms > Learning Rate Strategies > Constant_LR
...
Teach me "Constant LR" as part of the topic "Learning Rate Strategies" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Constant LR in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Constant LR from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Constant LR?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Constant LR connect to the broader context of "Learning Rate Strategies"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Constant LR correctly, using a real or toy dataset.
...
| **Full Path** | `Optimization Algorithms > Learning Rate Strategies > Constant_LR` |
