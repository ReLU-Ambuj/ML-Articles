...
**Context:** Optimization Algorithms > Learning Rate Strategies > Cyclic_Learning_Rates
...
Teach me "Cyclic Learning Rates" as part of the topic "Learning Rate Strategies" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Cyclic Learning Rates in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Cyclic Learning Rates from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Cyclic Learning Rates?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Cyclic Learning Rates connect to the broader context of "Learning Rate Strategies"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Cyclic Learning Rates correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Cyclic Learning Rates |
| **Parent Section** | Learning Rate Strategies |
| **Full Path** | `Optimization Algorithms > Learning Rate Strategies > Cyclic_Learning_Rates` |
