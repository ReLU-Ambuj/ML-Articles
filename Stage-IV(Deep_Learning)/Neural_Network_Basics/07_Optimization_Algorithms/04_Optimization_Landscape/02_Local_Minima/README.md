...
**Context:** Optimization Algorithms > Optimization Landscape > Local_Minima
...
Teach me "Local Minima" as part of the topic "Optimization Landscape" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Local Minima in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Local Minima from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Local Minima?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Local Minima connect to the broader context of "Optimization Landscape"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Local Minima correctly, using a real or toy dataset.
...
| **Full Path** | `Optimization Algorithms > Optimization Landscape > Local_Minima` |
