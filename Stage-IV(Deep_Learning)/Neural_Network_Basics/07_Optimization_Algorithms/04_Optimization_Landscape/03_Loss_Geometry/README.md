...
**Context:** Optimization Algorithms > Optimization Landscape > Loss_Geometry
...
Teach me "Loss Geometry" as part of the topic "Optimization Landscape" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Loss Geometry in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Loss Geometry from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Loss Geometry?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Loss Geometry connect to the broader context of "Optimization Landscape"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Loss Geometry correctly, using a real or toy dataset.
...
| **Full Path** | `Optimization Algorithms > Optimization Landscape > Loss_Geometry` |
