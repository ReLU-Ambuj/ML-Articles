...
**Context:** Loss Functions > Statistical Foundations > Information_Theory
...
Teach me "Information Theory" as part of the topic "Statistical Foundations" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Information Theory in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Information Theory from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Information Theory?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Information Theory connect to the broader context of "Statistical Foundations"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Information Theory correctly, using a real or toy dataset.
...
| **Parent Section** | Statistical Foundations |
| **Full Path** | `Loss Functions > Statistical Foundations > Information_Theory` |
