...
**Context:** Loss Functions > Regression Losses > Huber_Loss
...
Teach me "Huber Loss" as part of the topic "Regression Losses" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Huber Loss in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Huber Loss from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Huber Loss?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Huber Loss connect to the broader context of "Regression Losses"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Huber Loss correctly, using a real or toy dataset.
...
| **Full Path** | `Loss Functions > Regression Losses > Huber_Loss` |
