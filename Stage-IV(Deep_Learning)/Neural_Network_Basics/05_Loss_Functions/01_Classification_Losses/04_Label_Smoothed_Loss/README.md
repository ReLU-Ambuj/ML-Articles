...
**Context:** Loss Functions > Classification Losses > Label_Smoothed_Loss
...
Teach me "Label Smoothed Loss" as part of the topic "Classification Losses" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Label Smoothed Loss in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Label Smoothed Loss from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Label Smoothed Loss?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Label Smoothed Loss connect to the broader context of "Classification Losses"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Label Smoothed Loss correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Label Smoothed Loss |
| **Parent Section** | Classification Losses |
| **Full Path** | `Loss Functions > Classification Losses > Label_Smoothed_Loss` |
