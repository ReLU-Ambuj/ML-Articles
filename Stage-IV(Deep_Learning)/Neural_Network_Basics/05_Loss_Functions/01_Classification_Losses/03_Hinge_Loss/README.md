...
**Context:** Loss Functions > Classification Losses > Hinge_Loss
...
Teach me "Hinge Loss" as part of the topic "Classification Losses" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Hinge Loss in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Hinge Loss from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Hinge Loss?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Hinge Loss connect to the broader context of "Classification Losses"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Hinge Loss correctly, using a real or toy dataset.
...
| **Full Path** | `Loss Functions > Classification Losses > Hinge_Loss` |
