...
**Context:** Loss Functions > Classification Losses > Binary_Cross_Entropy
...
Teach me "Binary Cross Entropy" as part of the topic "Classification Losses" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Binary Cross Entropy in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Binary Cross Entropy from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Binary Cross Entropy?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Binary Cross Entropy connect to the broader context of "Classification Losses"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Binary Cross Entropy correctly, using a real or toy dataset.
...
| **Full Path** | `Loss Functions > Classification Losses > Binary_Cross_Entropy` |
