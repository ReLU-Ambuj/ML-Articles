...
**Context:** Loss Functions > Information Theoretic Losses > Jensen_Shannon_Divergence
...
Teach me "Jensen Shannon Divergence" as part of the topic "Information Theoretic Losses" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Jensen Shannon Divergence in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Jensen Shannon Divergence from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Jensen Shannon Divergence?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Jensen Shannon Divergence connect to the broader context of "Information Theoretic Losses"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Jensen Shannon Divergence correctly, using a real or toy dataset.
...
| **Parent Section** | Information Theoretic Losses |
| **Full Path** | `Loss Functions > Information Theoretic Losses > Jensen_Shannon_Divergence` |
