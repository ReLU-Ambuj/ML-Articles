...
**Context:** Loss Functions > Information Theoretic Losses > Mutual_Information
...
Teach me "Mutual Information" as part of the topic "Information Theoretic Losses" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Mutual Information in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Mutual Information from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Mutual Information?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Mutual Information connect to the broader context of "Information Theoretic Losses"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Mutual Information correctly, using a real or toy dataset.
...
| **Full Path** | `Loss Functions > Information Theoretic Losses > Mutual_Information` |
