...
**Context:** Loss Functions > Metric Learning Losses > Contrastive_Loss
...
Teach me "Contrastive Loss" as part of the topic "Metric Learning Losses" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Contrastive Loss in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Contrastive Loss from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Contrastive Loss?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Contrastive Loss connect to the broader context of "Metric Learning Losses"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Contrastive Loss correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Contrastive Loss |
| **Parent Section** | Metric Learning Losses |
| **Full Path** | `Loss Functions > Metric Learning Losses > Contrastive_Loss` |
