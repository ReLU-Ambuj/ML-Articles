...
**Context:** Regularization > L2_Regularization
...
Teach me "L2 Regularization" as part of the topic "Regularization" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is L2 Regularization in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement L2 Regularization from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about L2 Regularization?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does L2 Regularization connect to the broader context of "Regularization"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood L2 Regularization correctly, using a real or toy dataset.
...
| **Full Path** | `Regularization > L2_Regularization` |
