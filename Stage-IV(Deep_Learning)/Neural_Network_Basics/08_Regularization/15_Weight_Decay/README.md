...
**Context:** Regularization > Weight_Decay
...
Teach me "Weight Decay" as part of the topic "Regularization" in deep learning.
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Weight Decay from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Weight Decay?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Weight Decay connect to the broader context of "Regularization"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Weight Decay correctly, using a real or toy dataset.
...
| **Full Path** | `Regularization > Weight_Decay` |
