...
**Context:** Regularization > Stochastic_Depth
...
Teach me "Stochastic Depth" as part of the topic "Regularization" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Stochastic Depth in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Stochastic Depth from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Stochastic Depth?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Stochastic Depth connect to the broader context of "Regularization"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Stochastic Depth correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Stochastic Depth |
| **Parent Section** | Regularization |
| **Full Path** | `Regularization > Stochastic_Depth` |
