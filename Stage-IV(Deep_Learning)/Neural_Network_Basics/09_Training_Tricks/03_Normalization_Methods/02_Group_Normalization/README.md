...
**Context:** Training Tricks > Normalization Methods > Group_Normalization
...
Teach me "Group Normalization" as part of the topic "Normalization Methods" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Group Normalization in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Group Normalization from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Group Normalization?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Group Normalization connect to the broader context of "Normalization Methods"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Group Normalization correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Group Normalization |
| **Parent Section** | Normalization Methods |
| **Full Path** | `Training Tricks > Normalization Methods > Group_Normalization` |
