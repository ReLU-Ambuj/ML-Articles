...
**Context:** Training Tricks > Stability Techniques > Numerical_Stability
...
Teach me "Numerical Stability" as part of the topic "Stability Techniques" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Numerical Stability in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Numerical Stability from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Numerical Stability?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Numerical Stability connect to the broader context of "Stability Techniques"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Numerical Stability correctly, using a real or toy dataset.
...
| **Full Path** | `Training Tricks > Stability Techniques > Numerical_Stability` |
