...
**Context:** Training Tricks > Stability Techniques > Gradient_Clipping
...
Teach me "Gradient Clipping" as part of the topic "Stability Techniques" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Gradient Clipping in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Gradient Clipping from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Gradient Clipping?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Gradient Clipping connect to the broader context of "Stability Techniques"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Gradient Clipping correctly, using a real or toy dataset.
...
| **Full Path** | `Training Tricks > Stability Techniques > Gradient_Clipping` |
