...
**Context:** Training Tricks > Scheduling Methods > Linear_Decay
...
Teach me "Linear Decay" as part of the topic "Scheduling Methods" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Linear Decay in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Linear Decay from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Linear Decay?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Linear Decay connect to the broader context of "Scheduling Methods"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Linear Decay correctly, using a real or toy dataset.
...
| **Full Path** | `Training Tricks > Scheduling Methods > Linear_Decay` |
