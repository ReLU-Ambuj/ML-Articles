...
**Context:** Training Tricks > Initialization Schemes > Random_Initialization
...
Teach me "Random Initialization" as part of the topic "Initialization Schemes" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Random Initialization in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Random Initialization from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Random Initialization?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Random Initialization connect to the broader context of "Initialization Schemes"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Random Initialization correctly, using a real or toy dataset.
...
| **Full Path** | `Training Tricks > Initialization Schemes > Random_Initialization` |
