...
**Context:** Training Tricks > Initialization Schemes > Xavier_Initialization
...
Teach me "Xavier Initialization" as part of the topic "Initialization Schemes" in deep learning.

Structure your response as follows:

1. INTUITION FIRST (2–3 sentences)
   - What is Xavier Initialization in plain language?
...
4. CODE IMPLEMENTATION (Python / NumPy from scratch)
   - Implement Xavier Initialization from scratch in NumPy — no PyTorch/sklearn for the core logic.
   - Then show the PyTorch/JAX equivalent.
   - Run it on a small example and print intermediate values.

5. COMMON MISTAKES AND MISCONCEPTIONS
   - What do beginners get wrong about Xavier Initialization?
   - What edge cases or failure modes exist?

6. CONNECTIONS
   - How does Xavier Initialization connect to the broader context of "Initialization Schemes"?
...
7. MINI PROJECT
   - Give me one hands-on mini project (< 50 lines of Python) that lets me verify
     I have understood Xavier Initialization correctly, using a real or toy dataset.
...
| Field | Value |
|-------|-------|
| **Topic** | Xavier Initialization |
| **Parent Section** | Initialization Schemes |
| **Full Path** | `Training Tricks > Initialization Schemes > Xavier_Initialization` |
